...
public class Square extends SurfaceShape implements Moveable{
	...
	public Square (Point topLeftPoint, int sideLength, String contourColor)
	{
		this.topLeftPoint=topLeftPoint;
		this.sideLength=sideLength;
	...
	public String toString(){
		return "Point gore levo=("+topLeftPoint.getX()+","+topLeftPoint.getY()+"), stranica="+sideLength + ", color ivice=" + contourColor+ ", color unutrasnjosti=" + insideColor  ;
	}
