...
public class DijalogLinija extends JDialog {
	...
	public DijalogLinija() {
		...
		}
		{
			...
			txtX1.setColumns(10);
			txtX1.setText("" + ((Line)GuiCrtanje.getSelektovan()).gettStart().getX());
		}
		{
		...
		}
		{
			...
			txtY1.setColumns(10);
			txtY1.setText(""  + ((Line)GuiCrtanje.getSelektovan()).gettStart().getY());
		}
		{
		...
		}
		{
			...
			txtX2.setColumns(10);
			txtX2.setText("" + ((Line)GuiCrtanje.getSelektovan()).gettEnd().getX());
		}
		{
		...
		}
		{
			...
			txtY2.setColumns(10);
			txtY2.setText("" + ((Line)GuiCrtanje.getSelektovan()).gettEnd().getY());
		}
		{
